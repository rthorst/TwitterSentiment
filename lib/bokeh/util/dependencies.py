...
import shutil
import subprocess
#from subprocess import Popen, PIPE  # broken in cloud see https://github.com/adamchainz/django-mysql/issues/396
...
def detect_phantomjs(version='2.1'):
    ...
    try:
        proc = subprocess.Popen([phantomjs_path, "--version"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        proc.wait()
